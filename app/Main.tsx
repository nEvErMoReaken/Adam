  ...
  return (
    ...
    >
      <div className="pane-titlebar">
        <span className="font-semibold" style={{ color: active ? 'var(--c-blue)' : 'var(--c-text)' }}>
          {title}
        </span>
    ...
    <FocusCtx.Provider value={{ focused, setFocused }}>
      <div className="h-full">
        ...
        >
          ...
          <PaneShell index={0} title="whoami" paneNum={0} className="min-h-0">
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
              ...
              <div className="font-mono text-xs text-[var(--c-subtext0)] space-y-0.5">
                ...
                {!discord?.listening_to_spotify && (discord?.activities ?? []).filter(a => a.type !== 4).map((a, i) => (
          ...
          <div className="flex min-h-0 flex-col gap-px" style={{ backgroundColor: 'var(--c-split)' }}>
            ...
            <PaneShell index={1} title={t.quickStart} paneNum={1} className="shrink-0">
              <div className="p-4 font-mono text-sm space-y-1">
                ...
                <div className="pt-2 space-y-1 text-xs text-[var(--c-subtext0)]">
                  <p>{t.smiRobotHint}</p>
            ...
            {/* pane 2: code-stats */}
            <PaneShell index={2} title="code-stats" paneNum={2} className="flex-1 min-h-0">
