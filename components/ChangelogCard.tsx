  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* meta: hash + date */}
        <div className="ml-4 flex shrink-0 items-center gap-3" style={{ color: 'var(--c-overlay0)' }}>
          {date && <span>{date}</span>}
          {hash && (
            <span
      ...
      {children && (
        <div
          className="px-3 py-2.5 leading-relaxed [&_pre]:rounded [&_pre]:bg-[var(--c-mantle)] [&_pre]:px-3 [&_pre]:py-2 [&_pre]:text-[11px] [&_pre]:leading-relaxed [&_p]:mb-2 [&_p]:last:mb-0 [&_code]:text-[var(--c-mauve)]"
          style={{
