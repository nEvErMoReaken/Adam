        ...
        <div className="flex justify-center">
          <svg width="300" height="300" viewBox="0 0 300 300">
            ...
            {cur.data.map((hasData, i) => {
              ...
              const fill = isR ? C.blue : isW ? C.mauve : hasData ? C.blueDim : C.surface1
              return (
                <path
                  key={i}
                  d={wedgePath(i)}
            ...
            <text x={CX} y={CY + 11} textAnchor="middle" fontSize="9" fill={C.overlay0}>
              avail bytes
            </text>
          </svg>
        </div>
