      ...
      <div className="space-y-4 p-4 leading-relaxed">
        ...
        {loadState === 'idle' && (
          <div className="flex items-center gap-2">
            ...
            <span className="animate-pulse" style={{ color: 'var(--c-overlay0)' }}>
              █
            </span>
            {count === 0 && (
        ...
        {/* divider */}
        {loadState === 'done' && <div style={{ borderTop: '1px solid var(--c-split)' }} />}
          ...
          <>
            ...
            {user === null && (
              <div className="flex items-center gap-2">
                <span style={{ color: 'var(--c-green)' }}>❯</span>
                <a
                  href={`/api/auth/github?redirect=${encodeURIComponent(pathname)}`}
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    style={{
                      ...
                      cursor:
                        submitState === 'posting' || !input.trim() ? 'not-allowed' : 'pointer',
                      fontFamily: 'inherit',
                      fontSize: 'inherit',
                  ...
                  <span className="hidden sm:inline" style={{ color: 'var(--c-overlay0)' }}>
                    ⌘↵ / Ctrl↵
                  </span>
                  {submitState === 'error' && (
